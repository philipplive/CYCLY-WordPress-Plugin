...
class Less_Cache {
	 ...
	 * @param callable $oncompile
	 * @return string Name of the css file
	 */
	public static function Get($less_files, $parser_options = array(), $modify_vars = array(), $oncompile = null) {
	...
	private static function CompiledName($files, $extrahash) {
		...
		foreach ($files as $file) {
			$temp[] = file_exists($file) ? filemtime($file)."\t".filesize($file)."\t".$file : null;
		}
